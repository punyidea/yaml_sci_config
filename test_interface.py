...
from yaml_sci_config.yaml_interface import yaml_dataclass, FunctionHandle, PartialFunctionHandle
import re
import numpy as np
...
'''
    ...
    def test_class_subtype(self):
        ...
        B = yaml_interface.PartialClassObject.init_from_class(TestYamlPostinit, test_type1=24)
